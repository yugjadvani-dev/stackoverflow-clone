      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            Welcome to our Stack Overflow clone website. By accessing or using
        ...
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            You are solely responsible for the content you post on our website.
            We reserve the right to remove any content that we deem
            inappropriate or in violation of our policies. You agree not to post
            any content that is illegal, harassing, defamatory, or infringes on
        ...
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            ...
            images, and code snippets, is the property of our company or its
        ...
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Our website and services are provided &ldquo;as is&ldquo; and
            without warranty of any kind, either express or implied. We do not
            guarantee that our website or services will be error-free or
        ...
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            ...
            with your use of our website or services. Our total liability shall
            not exceed $100.
          </p>
        </div>
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            ...
            accordance with the laws of the state of California. Any disputes
            arising out of or in connection with these terms of service shall be
